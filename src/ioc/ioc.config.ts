...
import { EducationQueueFsRepository } from './../repositories/education.queue.fs.repository';
import { EducationQueueFsService } from './../services/education.queue.fs.service';
...
iocContainer.bind<IEducationQueueRepository>(REPOSITORY_TYPES.IEducationQueueRepository).to(EducationQueueFsRepository);
...
iocContainer.bind<IEducationQueueService>(SERVICE_TYPES.IEducationQueueService).to(EducationQueueFsService);
