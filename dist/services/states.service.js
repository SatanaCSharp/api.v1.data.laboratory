...
var StatesService = (function () {
    function StatesService(statesRepository, stateMapper) {
        var _this = this;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 3]);
                        _b = (_a = res).send;
                        return [4, this.statesRepository.findAll()];
                    case 1:
                        _b.apply(_a, [_c.sent()]);
                        return [3, 3];
                    case 2:
        ...
        this.create = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var stateEntity, _a, _b, err_2;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 3]);
                        stateEntity = this.stateMapper.mapRequestToEntity(req);
                        _b = (_a = res).send;
                        return [4, this.statesRepository.create(stateEntity)];
                    case 1:
                        _b.apply(_a, [_c.sent()]);
                        return [3, 3];
                    case 2:
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        stateEntity = this.stateMapper.mapRequestToEntity(req);
                        _b = (_a = res).send;
                        return [4, this.statesRepository.update(req.params.id, stateEntity)];
                    case 1:
                        _b.apply(_a, [_c.sent()]);
                        return [3, 3];
                    case 2:
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 3]);
                        _b = (_a = res).send;
                        return [4, this.statesRepository.delete(req.params.id)];
                    case 1:
                        _b.apply(_a, [_c.sent()]);
                        return [3, 3];
                    case 2:
    ...
    StatesService = __decorate([
        ...
        __param(0, inversify_1.inject(types_2.REPOSITORY_TYPES.IStatesRepository)),
        __param(1, inversify_1.inject(types_1.MAPPER_TYPES.StateMapper)),
